...
import { User, Baby, Heart, ChevronRight } from "lucide-react";
    ...
    <PageShell>
      ...
      <div className="px-4 pt-6 pb-4 max-w-xl mx-auto w-full">
        <p className="text-muted text-sm mb-6">
          Yaş grubuna göre acil müdahale algoritmalarına ulaşın.
        </p>
