...
const causes4H = [
  ...
  {
    letter: "H",
    title: "Hipo/Hiperkalemi (Metabolik)",
    detail: "İyon bozuklukları: K⁺, Ca²⁺, Na⁺, asidoz — AGK/kan gazı",
...
const causes4T = [
  ...
  {
    letter: "T",
    title: "Tromboz (Pulmoner / Koroner)",
    detail: "PE → tromboliz; STEMI → primer PCI veya tromboliz",
    ...
    <PageShell>
      ...
      <main className="flex-1 px-3 sm:px-6 py-4 sm:py-6 w-full max-w-xl mx-auto space-y-4">
        ...
        <div className="bg-red-500/10 dark:bg-red-500/15 text-red-700 dark:text-red-400 border-b border-black/5 dark:border-white/10 rounded-xl p-3.5">
          ...
          <p className="text-sm font-black">KPR sırasında 4H & 4T</p>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2 px-1">
            <span className="w-7 h-7 rounded-full bg-red-500/10 dark:bg-red-500/15 text-red-700 dark:text-red-400 border-b border-black/5 dark:border-white/10 flex items-center justify-center text-xs font-black">4H</span>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2 px-1">
            <span className="w-7 h-7 rounded-full bg-violet-500/10 dark:bg-violet-500/15 text-violet-700 dark:text-violet-400 border-b border-black/5 dark:border-white/10 flex items-center justify-center text-xs font-black">4T</span>
