...
const causes5H = [
  {
    ...
    color:
      "border-red-200 dark:border-red-500/30 bg-red-500/10 dark:bg-red-500/15",
  ...
  },
  {
    ...
    color:
      "border-orange-200 dark:border-orange-500/30 bg-orange-500/10 dark:bg-orange-500/15",
  ...
  },
  {
    ...
    color:
      "border-blue-200 dark:border-blue-500/30 bg-blue-500/10 dark:bg-blue-500/15",
  ...
  },
  {
    ...
    color:
      "border-emerald-200 dark:border-emerald-500/30 bg-emerald-500/10 dark:bg-emerald-500/15",
  ...
  },
  {
    ...
    color:
      "border-pink-200 dark:border-pink-500/30 bg-pink-500/10 dark:bg-pink-500/15",
...
const causes5T = [
  {
    ...
    detail: "5.Mid aksiller hatta iğne dekompresyonu",
    color:
      "border-violet-200 dark:border-violet-500/30 bg-violet-500/10 dark:bg-violet-500/15",
  ...
  },
  {
    ...
    color:
      "border-fuchsia-200 dark:border-fuchsia-500/30 bg-fuchsia-500/10 dark:bg-fuchsia-500/15",
  ...
  },
  {
    ...
    detail: "PE → tromboliz",
    color:
      "border-rose-200 dark:border-rose-500/30 bg-rose-500/10 dark:bg-rose-500/15",
  ...
  },
  {
    ...
    color:
      "border-teal-200 dark:border-teal-500/30 bg-teal-500/10 dark:bg-teal-500/15",
...
export default function GeriDondurulebilirPage() {
  return (
    <PageShell>
      <AppHeader
        title="Geri Döndürülebilir Nedenler"
        back="/skalalar"
      ...
      <main className="flex-1 px-3 sm:px-6 py-4 sm:py-6 w-full max-w-xl mx-auto space-y-4">
        ...
        <div className="bg-red-500/10 dark:bg-red-500/15 text-red-700 dark:text-red-400 border-b border-black/5 dark:border-white/10 rounded-xl p-3.5">
          ...
          <p className="text-[11px] opacity-75 mt-1 text-slate-700 dark:text-white/90">
            Her arrest vakasında bu nedenleri sistematik olarak ara ve tedavi et
          </p>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2 px-1">
            <span className="w-7 h-7 rounded-full bg-red-500/10 dark:bg-red-500/15 text-red-700 dark:text-red-400 border-b border-black/5 dark:border-white/10 flex items-center justify-center text-xs font-black">
              5H
            </span>
            <h2 className="text-sm font-extrabold text-slate-800 dark:text-white/90">
              H ile Başlayanlar
            </h2>
          </div>
          <div className="space-y-2">
            {causes5H.map((item, i) => (
              <div
                key={i}
                className={`rounded-xl border-2 p-3.5 flex gap-3 items-start ${item.color}`}
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-slate-600 dark:text-white/90 leading-relaxed">
                    {item.detail}
                  </p>
                </div>
              </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-2 px-1">
            <span className="w-7 h-7 rounded-full bg-violet-500/10 dark:bg-violet-500/15 text-violet-700 dark:text-violet-400 border-b border-black/5 dark:border-white/10 flex items-center justify-center text-xs font-black">
              5T
            </span>
            <h2 className="text-sm font-extrabold text-slate-800 dark:text-white/90">
              T ile Başlayanlar
